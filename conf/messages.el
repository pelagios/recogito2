...
document.settings.backup.description=Η δέσμη αρχείων ασφαλείας περιλαμβάνει τα μεταδεδομένα του \
  ...
  ασφαλείας για επιπλέον ασφάλεια. Σημείωση: το ιστορικό επεξεργασίας δεν περιλαμβάνεται προς \
  το παρόν στη δέσμη αρχείων ασφαλείας.
document.settings.backup.button=Κατεβάστε μία δέσμη αρχείων ασφαλείας ΖΙΡ
