...
class UploadFilepart(alias : String, aliased : Table[UploadFilepartRecord], parameters : Array[ Field[_] ]) extends TableImpl[UploadFilepartRecord](alias, Public.PUBLIC, aliased, parameters, "") {
	...
	/**
	 * The column <code>public.upload_filepart.file</code>.
	 */
	val FILE : TableField[UploadFilepartRecord, String] = createField("file", org.jooq.impl.SQLDataType.CLOB.nullable(false), "")
	...
	def this(alias : String) = {
		this(alias, services.generated.tables.UploadFilepart.UPLOAD_FILEPART, null)
	}
