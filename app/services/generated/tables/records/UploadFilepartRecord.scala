...
class UploadFilepartRecord extends UpdatableRecordImpl[UploadFilepartRecord](UploadFilepart.UPLOAD_FILEPART) with Record9[UUID, Integer, String, String, String, String, Double, String, Integer] {
	...
	/**
	 * Setter for <code>public.upload_filepart.sequence_no</code>.
	 */
	...
	/**
	 * Getter for <code>public.upload_filepart.sequence_no</code>.
	 */
	...
	override def fieldsRow : Row9[UUID, Integer, String, String, String, String, Double, String, Integer] = {
		super.fieldsRow.asInstanceOf[ Row9[UUID, Integer, String, String, String, String, Double, String, Integer] ]
	}

	override def valuesRow : Row9[UUID, Integer, String, String, String, String, Double, String, Integer] = {
		super.valuesRow.asInstanceOf[ Row9[UUID, Integer, String, String, String, String, Double, String, Integer] ]
	}
	...
	override def field9 : Field[Integer] = UploadFilepart.UPLOAD_FILEPART.SEQUENCE_NO
	...
	override def value9 : Integer = getSequenceNo
	...
	override def value9(value : Integer) : UploadFilepartRecord = {
		setSequenceNo(value)
		this
	}

	override def values(value1 : UUID, value2 : Integer, value3 : String, value4 : String, value5 : String, value6 : String, value7 : Double, value8 : String, value9 : Integer) : UploadFilepartRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(id : UUID, uploadId : Integer, owner : String, title : String, contentType : String, file : String, filesizeKb : Double, source : String, sequenceNo : Integer) = {
		this()
