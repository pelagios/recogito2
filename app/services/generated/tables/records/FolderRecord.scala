...
class FolderRecord extends UpdatableRecordImpl[FolderRecord](Folder.FOLDER) with Record4[UUID, String, String, UUID] {
	...
	override def fieldsRow : Row4[UUID, String, String, UUID] = {
		super.fieldsRow.asInstanceOf[ Row4[UUID, String, String, UUID] ]
	}

	override def valuesRow : Row4[UUID, String, String, UUID] = {
		super.valuesRow.asInstanceOf[ Row4[UUID, String, String, UUID] ]
	}
	...
	override def values(value1 : UUID, value2 : String, value3 : String, value4 : UUID) : FolderRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(id : UUID, owner : String, title : String, parent : UUID) = {
		this()
