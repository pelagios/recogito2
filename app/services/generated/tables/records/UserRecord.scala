...
class UserRecord extends UpdatableRecordImpl[UserRecord](User.USER) with Record9[String, String, String, String, Timestamp, String, String, String, Integer] {
	...
	override def fieldsRow : Row9[String, String, String, String, Timestamp, String, String, String, Integer] = {
		super.fieldsRow.asInstanceOf[ Row9[String, String, String, String, Timestamp, String, String, String, Integer] ]
	}

	override def valuesRow : Row9[String, String, String, String, Timestamp, String, String, String, Integer] = {
		super.valuesRow.asInstanceOf[ Row9[String, String, String, String, Timestamp, String, String, String, Integer] ]
	}
	...
	override def values(value1 : String, value2 : String, value3 : String, value4 : String, value5 : Timestamp, value6 : String, value7 : String, value8 : String, value9 : Integer) : UserRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(username : String, email : String, passwordHash : String, salt : String, memberSince : Timestamp, realName : String, bio : String, website : String, quotaMb : Integer) = {
		this()
