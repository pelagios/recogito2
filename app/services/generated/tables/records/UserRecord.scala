...
class UserRecord extends UpdatableRecordImpl[UserRecord](User.USER) with Record10[String, String, String, String, Timestamp, String, String, String, Integer, Timestamp] {
	...
	override def fieldsRow : Row10[String, String, String, String, Timestamp, String, String, String, Integer, Timestamp] = {
		super.fieldsRow.asInstanceOf[ Row10[String, String, String, String, Timestamp, String, String, String, Integer, Timestamp] ]
	}

	override def valuesRow : Row10[String, String, String, String, Timestamp, String, String, String, Integer, Timestamp] = {
		super.valuesRow.asInstanceOf[ Row10[String, String, String, String, Timestamp, String, String, String, Integer, Timestamp] ]
	}
	...
	override def values(value1 : String, value2 : String, value3 : String, value4 : String, value5 : Timestamp, value6 : String, value7 : String, value8 : String, value9 : Integer, value10 : Timestamp) : UserRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(username : String, email : String, passwordHash : String, salt : String, memberSince : Timestamp, realName : String, bio : String, website : String, quotaMb : Integer, lastLogin : Timestamp) = {
		this()
