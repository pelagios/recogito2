...
class DocumentRecord extends UpdatableRecordImpl[DocumentRecord](Document.DOCUMENT) with Record16[String, String, Timestamp, String, String, Timestamp, String, String, String, String, String, String, String, String, String, String] {
	...
	override def fieldsRow : Row16[String, String, Timestamp, String, String, Timestamp, String, String, String, String, String, String, String, String, String, String] = {
		super.fieldsRow.asInstanceOf[ Row16[String, String, Timestamp, String, String, Timestamp, String, String, String, String, String, String, String, String, String, String] ]
	}

	override def valuesRow : Row16[String, String, Timestamp, String, String, Timestamp, String, String, String, String, String, String, String, String, String, String] = {
		super.valuesRow.asInstanceOf[ Row16[String, String, Timestamp, String, String, Timestamp, String, String, String, String, String, String, String, String, String, String] ]
	}
	...
	override def field13 : Field[String] = Document.DOCUMENT.ATTRIBUTION
	override def field14 : Field[String] = Document.DOCUMENT.PUBLIC_VISIBILITY
	override def field15 : Field[String] = Document.DOCUMENT.PUBLIC_ACCESS_LEVEL
	override def field16 : Field[String] = Document.DOCUMENT.CLONED_FROM
	...
	override def value13 : String = getAttribution
	override def value14 : String = getPublicVisibility
	override def value15 : String = getPublicAccessLevel
	override def value16 : String = getClonedFrom
	...
	override def values(value1 : String, value2 : String, value3 : Timestamp, value4 : String, value5 : String, value6 : Timestamp, value7 : String, value8 : String, value9 : String, value10 : String, value11 : String, value12 : String, value13 : String, value14 : String, value15 : String, value16 : String) : DocumentRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(id : String, owner : String, uploadedAt : Timestamp, title : String, author : String, dateNumeric : Timestamp, dateFreeform : String, description : String, language : String, source : String, edition : String, license : String, attribution : String, publicVisibility : String, publicAccessLevel : String, clonedFrom : String) = {
		this()
		...
		setValue(10, edition)
		setValue(11, license)
		setValue(12, attribution)
		setValue(13, publicVisibility)
		setValue(14, publicAccessLevel)
		setValue(15, clonedFrom)
	}
}
