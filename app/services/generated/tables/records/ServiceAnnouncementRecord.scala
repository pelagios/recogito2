...
class ServiceAnnouncementRecord extends UpdatableRecordImpl[ServiceAnnouncementRecord](ServiceAnnouncement.SERVICE_ANNOUNCEMENT) with Record6[UUID, String, String, Timestamp, Timestamp, String] {
	...
	override def fieldsRow : Row6[UUID, String, String, Timestamp, Timestamp, String] = {
		super.fieldsRow.asInstanceOf[ Row6[UUID, String, String, Timestamp, Timestamp, String] ]
	}

	override def valuesRow : Row6[UUID, String, String, Timestamp, Timestamp, String] = {
		super.valuesRow.asInstanceOf[ Row6[UUID, String, String, Timestamp, Timestamp, String] ]
	}
	override def field1 : Field[UUID] = ServiceAnnouncement.SERVICE_ANNOUNCEMENT.ID
	...
	override def value1(value : UUID) : ServiceAnnouncementRecord = {
		setId(value)
		this
	}
	...
	override def values(value1 : UUID, value2 : String, value3 : String, value4 : Timestamp, value5 : Timestamp, value6 : String) : ServiceAnnouncementRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(id : UUID, forUser : String, content : String, createdAt : Timestamp, viewedAt : Timestamp, response : String) = {
		this()
