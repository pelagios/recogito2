...
class TaskRecord extends UpdatableRecordImpl[TaskRecord](Task.TASK) with Record10[UUID, String, String, String, String, Timestamp, Timestamp, String, String, Integer] {
	...
	override def fieldsRow : Row10[UUID, String, String, String, String, Timestamp, Timestamp, String, String, Integer] = {
		super.fieldsRow.asInstanceOf[ Row10[UUID, String, String, String, String, Timestamp, Timestamp, String, String, Integer] ]
	}

	override def valuesRow : Row10[UUID, String, String, String, String, Timestamp, Timestamp, String, String, Integer] = {
		super.valuesRow.asInstanceOf[ Row10[UUID, String, String, String, String, Timestamp, Timestamp, String, String, Integer] ]
	}
	...
	override def values(value1 : UUID, value2 : String, value3 : String, value4 : String, value5 : String, value6 : Timestamp, value7 : Timestamp, value8 : String, value9 : String, value10 : Integer) : TaskRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(id : UUID, taskType : String, className : String, lookupKey : String, spawnedBy : String, spawnedAt : Timestamp, stoppedAt : Timestamp, stoppedWith : String, status : String, progress : Integer) = {
		this()
