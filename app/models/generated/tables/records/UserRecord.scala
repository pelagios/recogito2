...
class UserRecord extends UpdatableRecordImpl[UserRecord](User.USER) with Record6[String, String, String, String, Timestamp, Boolean] {
	...
	override def fieldsRow : Row6[String, String, String, String, Timestamp, Boolean] = {
		super.fieldsRow.asInstanceOf[ Row6[String, String, String, String, Timestamp, Boolean] ]
	}

	override def valuesRow : Row6[String, String, String, String, Timestamp, Boolean] = {
		super.valuesRow.asInstanceOf[ Row6[String, String, String, String, Timestamp, Boolean] ]
	}
	...
	override def values(value1 : String, value2 : String, value3 : String, value4 : String, value5 : Timestamp, value6 : Boolean) : UserRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(username : String, email : String, passwordHash : String, salt : String, memberSince : Timestamp, active : Boolean) = {
		this()
