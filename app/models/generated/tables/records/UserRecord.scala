...
class UserRecord extends UpdatableRecordImpl[UserRecord](User.USER) with Record10[String, String, String, String, Timestamp, String, String, String, Integer, Boolean] {
	...
	override def fieldsRow : Row10[String, String, String, String, Timestamp, String, String, String, Integer, Boolean] = {
		super.fieldsRow.asInstanceOf[ Row10[String, String, String, String, Timestamp, String, String, String, Integer, Boolean] ]
	}

	override def valuesRow : Row10[String, String, String, String, Timestamp, String, String, String, Integer, Boolean] = {
		super.valuesRow.asInstanceOf[ Row10[String, String, String, String, Timestamp, String, String, String, Integer, Boolean] ]
	}
	...
	override def field10 : Field[Boolean] = User.USER.ACTIVE
	...
	override def value10 : Boolean = getActive
	...
	override def value10(value : Boolean) : UserRecord = {
		setActive(value)
		this
	}

	override def values(value1 : String, value2 : String, value3 : String, value4 : String, value5 : Timestamp, value6 : String, value7 : String, value8 : String, value9 : Integer, value10 : Boolean) : UserRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(username : String, email : String, passwordHash : String, salt : String, memberSince : Timestamp, realName : String, bio : String, website : String, quotaMb : Integer, active : Boolean) = {
		this()
