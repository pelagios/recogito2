...
class UploadRecord extends UpdatableRecordImpl[UploadRecord](Upload.UPLOAD) with Record9[Integer, String, OffsetDateTime, String, String, String, String, String, String] {

	/**
	 * Setter for <code>upload.id</code>.
	 */
	...
	/**
	 * Getter for <code>upload.id</code>.
	 */
	def getId : Integer = {
		val r = getValue(0)
	...
	/**
	 * Setter for <code>upload.owner</code>.
	 */
	...
	/**
	 * Getter for <code>upload.owner</code>.
	 */
	def getOwner : String = {
		val r = getValue(1)
	...
	/**
	 * Setter for <code>upload.created_at</code>.
	 */
	...
	/**
	 * Getter for <code>upload.created_at</code>.
	 */
	...
	/**
	 * Setter for <code>upload.title</code>.
	 */
	...
	/**
	 * Getter for <code>upload.title</code>.
	 */
	def getTitle : String = {
		val r = getValue(3)
		if (r == null) null else r.asInstanceOf[String]
	...
	/**
	 * Setter for <code>upload.author</code>.
	 */
	...
	/**
	 * Getter for <code>upload.author</code>.
	 */
	...
	/**
	 * Setter for <code>upload.date_freeform</code>.
	 */
	...
	/**
	 * Getter for <code>upload.date_freeform</code>.
	 */
	...
	/**
	 * Setter for <code>upload.description</code>.
	 */
	...
	/**
	 * Getter for <code>upload.description</code>.
	 */
	...
	/**
	 * Setter for <code>upload.source</code>.
	 */
	...
	/**
	 * Getter for <code>upload.source</code>.
	 */
	...
	/**
	 * Setter for <code>upload.language</code>.
	 */
	...
	/**
	 * Getter for <code>upload.language</code>.
	 */
	...
	override def fieldsRow : Row9[Integer, String, OffsetDateTime, String, String, String, String, String, String] = {
		super.fieldsRow.asInstanceOf[ Row9[Integer, String, OffsetDateTime, String, String, String, String, String, String] ]
	}

	override def valuesRow : Row9[Integer, String, OffsetDateTime, String, String, String, String, String, String] = {
		super.valuesRow.asInstanceOf[ Row9[Integer, String, OffsetDateTime, String, String, String, String, String, String] ]
	}
	override def field1 : Field[Integer] = Upload.UPLOAD.ID
	override def field2 : Field[String] = Upload.UPLOAD.OWNER
	override def field3 : Field[OffsetDateTime] = Upload.UPLOAD.CREATED_AT
	...
	override def value3(value : OffsetDateTime) : UploadRecord = {
		setCreatedAt(value)
		this
	}
	...
	override def values(value1 : Integer, value2 : String, value3 : OffsetDateTime, value4 : String, value5 : String, value6 : String, value7 : String, value8 : String, value9 : String) : UploadRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(id : Integer, owner : String, createdAt : OffsetDateTime, title : String, author : String, dateFreeform : String, description : String, source : String, language : String) = {
		this()
