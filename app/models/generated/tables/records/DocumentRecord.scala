...
class DocumentRecord extends UpdatableRecordImpl[DocumentRecord](Document.DOCUMENT) with Record12[String, String, Timestamp, String, String, Timestamp, String, String, String, String, String, Boolean] {
	...
	override def fieldsRow : Row12[String, String, Timestamp, String, String, Timestamp, String, String, String, String, String, Boolean] = {
		super.fieldsRow.asInstanceOf[ Row12[String, String, Timestamp, String, String, Timestamp, String, String, String, String, String, Boolean] ]
	}

	override def valuesRow : Row12[String, String, Timestamp, String, String, Timestamp, String, String, String, String, String, Boolean] = {
		super.valuesRow.asInstanceOf[ Row12[String, String, Timestamp, String, String, Timestamp, String, String, String, String, String, Boolean] ]
	}
	...
	override def field12 : Field[Boolean] = Document.DOCUMENT.IS_PUBLIC
	...
	override def value12 : Boolean = getIsPublic
	...
	override def value12(value : Boolean) : DocumentRecord = {
		setIsPublic(value)
		this
	}

	override def values(value1 : String, value2 : String, value3 : Timestamp, value4 : String, value5 : String, value6 : Timestamp, value7 : String, value8 : String, value9 : String, value10 : String, value11 : String, value12 : Boolean) : DocumentRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(id : String, owner : String, uploadedAt : Timestamp, title : String, author : String, dateNumeric : Timestamp, dateFreeform : String, description : String, language : String, source : String, edition : String, isPublic : Boolean) = {
		this()
