...
class DocumentRecord extends UpdatableRecordImpl[DocumentRecord](Document.DOCUMENT) with Record10[Integer, String, OffsetDateTime, String, String, Timestamp, String, String, String, String] {
	...
	/**
	 * Setter for <code>document.uploaded_at</code>.
	 */
	def setUploadedAt(value : OffsetDateTime) : Unit = {
		setValue(2, value)
	}

	/**
	 * Getter for <code>document.uploaded_at</code>.
	 */
	def getUploadedAt : OffsetDateTime = {
		val r = getValue(2)
	...
	override def fieldsRow : Row10[Integer, String, OffsetDateTime, String, String, Timestamp, String, String, String, String] = {
		super.fieldsRow.asInstanceOf[ Row10[Integer, String, OffsetDateTime, String, String, Timestamp, String, String, String, String] ]
	}

	override def valuesRow : Row10[Integer, String, OffsetDateTime, String, String, Timestamp, String, String, String, String] = {
		super.valuesRow.asInstanceOf[ Row10[Integer, String, OffsetDateTime, String, String, Timestamp, String, String, String, String] ]
	}
	override def field1 : Field[Integer] = Document.DOCUMENT.ID
	override def field2 : Field[String] = Document.DOCUMENT.OWNER
	override def field3 : Field[OffsetDateTime] = Document.DOCUMENT.UPLOADED_AT
	...
	override def value3 : OffsetDateTime = getUploadedAt
	...
	override def value3(value : OffsetDateTime) : DocumentRecord = {
		setUploadedAt(value)
		this
	}
	...
	override def values(value1 : Integer, value2 : String, value3 : OffsetDateTime, value4 : String, value5 : String, value6 : Timestamp, value7 : String, value8 : String, value9 : String, value10 : String) : DocumentRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(id : Integer, owner : String, uploadedAt : OffsetDateTime, title : String, author : String, dateNumeric : Timestamp, dateFreeform : String, description : String, source : String, language : String) = {
		this()
