...
class DocumentRecord extends UpdatableRecordImpl[DocumentRecord](Document.DOCUMENT) with Record10[String, String, OffsetDateTime, String, String, Timestamp, String, String, String, String] {
	...
	override def fieldsRow : Row10[String, String, OffsetDateTime, String, String, Timestamp, String, String, String, String] = {
		super.fieldsRow.asInstanceOf[ Row10[String, String, OffsetDateTime, String, String, Timestamp, String, String, String, String] ]
	}

	override def valuesRow : Row10[String, String, OffsetDateTime, String, String, Timestamp, String, String, String, String] = {
		super.valuesRow.asInstanceOf[ Row10[String, String, OffsetDateTime, String, String, Timestamp, String, String, String, String] ]
	}
	...
	override def values(value1 : String, value2 : String, value3 : OffsetDateTime, value4 : String, value5 : String, value6 : Timestamp, value7 : String, value8 : String, value9 : String, value10 : String) : DocumentRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(id : String, owner : String, uploadedAt : OffsetDateTime, title : String, author : String, dateNumeric : Timestamp, dateFreeform : String, description : String, source : String, language : String) = {
		this()
