...
class DocumentFilepartRecord extends UpdatableRecordImpl[DocumentFilepartRecord](DocumentFilepart.DOCUMENT_FILEPART) with Record6[Integer, Integer, String, String, String, Integer] {
	...
	override def fieldsRow : Row6[Integer, Integer, String, String, String, Integer] = {
		super.fieldsRow.asInstanceOf[ Row6[Integer, Integer, String, String, String, Integer] ]
	}

	override def valuesRow : Row6[Integer, Integer, String, String, String, Integer] = {
		super.valuesRow.asInstanceOf[ Row6[Integer, Integer, String, String, String, Integer] ]
	}
	...
	override def values(value1 : Integer, value2 : Integer, value3 : String, value4 : String, value5 : String, value6 : Integer) : DocumentFilepartRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(id : Integer, documentId : Integer, title : String, contentType : String, filename : String, sequenceNo : Integer) = {
		this()
