...
class DocumentFilepartRecord extends UpdatableRecordImpl[DocumentFilepartRecord](DocumentFilepart.DOCUMENT_FILEPART) with Record7[UUID, String, String, String, String, Integer, String] {
	...
	/**
	 * Setter for <code>public.document_filepart.source</code>.
	 */
	...
	/**
	 * Getter for <code>public.document_filepart.source</code>.
	 */
	...
	override def fieldsRow : Row7[UUID, String, String, String, String, Integer, String] = {
		super.fieldsRow.asInstanceOf[ Row7[UUID, String, String, String, String, Integer, String] ]
	}

	override def valuesRow : Row7[UUID, String, String, String, String, Integer, String] = {
		super.valuesRow.asInstanceOf[ Row7[UUID, String, String, String, String, Integer, String] ]
	}
	...
	override def field7 : Field[String] = DocumentFilepart.DOCUMENT_FILEPART.SOURCE
	...
	override def value7 : String = getSource
	...
	override def values(value1 : UUID, value2 : String, value3 : String, value4 : String, value5 : String, value6 : Integer, value7 : String) : DocumentFilepartRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(id : UUID, documentId : String, title : String, contentType : String, file : String, sequenceNo : Integer, source : String) = {
		this()
