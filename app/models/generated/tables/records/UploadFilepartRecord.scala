...
class UploadFilepartRecord extends UpdatableRecordImpl[UploadFilepartRecord](UploadFilepart.UPLOAD_FILEPART) with Record7[Integer, Integer, String, String, String, String, Float] {
	 ...
	 */
	def setFilesizeKb(value : Float) : Unit = {
		setValue(6, value)
	}
	...
	override def fieldsRow : Row7[Integer, Integer, String, String, String, String, Float] = {
		super.fieldsRow.asInstanceOf[ Row7[Integer, Integer, String, String, String, String, Float] ]
	}

	override def valuesRow : Row7[Integer, Integer, String, String, String, String, Float] = {
		super.valuesRow.asInstanceOf[ Row7[Integer, Integer, String, String, String, String, Float] ]
	}
	...
	override def field7 : Field[Float] = UploadFilepart.UPLOAD_FILEPART.FILESIZE_KB
	...
	override def value7 : Float = getFilesizeKb
	...
	override def value7(value : Float) : UploadFilepartRecord = {
		setFilesizeKb(value)
		this
	}

	override def values(value1 : Integer, value2 : Integer, value3 : String, value4 : String, value5 : String, value6 : String, value7 : Float) : UploadFilepartRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(id : Integer, uploadId : Integer, owner : String, title : String, contentType : String, filename : String, filesizeKb : Float) = {
		this()
