...
class SharingPolicyRecord extends UpdatableRecordImpl[SharingPolicyRecord](SharingPolicy.SHARING_POLICY) with Record7[Integer, Integer, String, String, String, Timestamp, String] {
	...
	override def fieldsRow : Row7[Integer, Integer, String, String, String, Timestamp, String] = {
		super.fieldsRow.asInstanceOf[ Row7[Integer, Integer, String, String, String, Timestamp, String] ]
	}

	override def valuesRow : Row7[Integer, Integer, String, String, String, Timestamp, String] = {
		super.valuesRow.asInstanceOf[ Row7[Integer, Integer, String, String, String, Timestamp, String] ]
	}
	...
	override def values(value1 : Integer, value2 : Integer, value3 : String, value4 : String, value5 : String, value6 : Timestamp, value7 : String) : SharingPolicyRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(id : Integer, folderId : Integer, documentId : String, sharedBy : String, sharedWith : String, sharedAt : Timestamp, accessLevel : String) = {
		this()
