...
class SharingPolicyRecord extends UpdatableRecordImpl[SharingPolicyRecord](SharingPolicy.SHARING_POLICY) with Record6[Integer, Integer, String, String, String, Timestamp] {
	...
	override def fieldsRow : Row6[Integer, Integer, String, String, String, Timestamp] = {
		super.fieldsRow.asInstanceOf[ Row6[Integer, Integer, String, String, String, Timestamp] ]
	}

	override def valuesRow : Row6[Integer, Integer, String, String, String, Timestamp] = {
		super.valuesRow.asInstanceOf[ Row6[Integer, Integer, String, String, String, Timestamp] ]
	}
	...
	override def values(value1 : Integer, value2 : Integer, value3 : String, value4 : String, value5 : String, value6 : Timestamp) : SharingPolicyRecord = {
		this.value1(value1)
		this.value2(value2)
		this.value3(value3)
		this.value4(value4)
	 ...
	 */
	def this(id : Integer, folderId : Integer, documentId : String, sharedBy : String, sharedWith : String, sharedAt : Timestamp) = {
		this()
