...
class NERServiceIntegrationSpec extends TestKit(ActorSystem()) with ImplicitSender with SpecificationLike with AfterAll {
  ...
  "The NER service" should {
    ...
    // Two test documents
    val document1 = new DocumentRecord("hcylkmacy4xgkb", "rainer", now, "A short test doc", null, null, null, null, null, null, null)
    val document2 = new DocumentRecord("98muze1cl3saib", "rainer", now, "A long test doc", null, null, null, null, null, null, null)
